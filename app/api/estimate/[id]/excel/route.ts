...
const excelCache = new BoundedCache<Uint8Array>(50, 1000 * 60 * 30); // Max 50 items, 30-min TTL
...
export async function GET(
  ...
  const cachedBytes = !noCache ? excelCache.get(id) : undefined;
  ...
  try {
    ...
    // Cache rendered Excel in bounded LRU cache
