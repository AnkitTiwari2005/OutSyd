  ...
  try {
    ...
    await db.transaction(async (tx) => {
      ...
      await tx.insert(buildingInputs).values({
        ...
        localRateOverrides: bi.localRateOverrides ? JSON.stringify(bi.localRateOverrides) : null,
